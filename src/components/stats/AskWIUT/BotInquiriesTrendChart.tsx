...
import { getBotInquiriesTrendLatest } from "../../../api/AskWIUT/BotInquiriesTrend/latest";

const BotInquiriesTrendChart: FC = () => {
  ...
  const handleGetBotInquiriesTrend = async (filteredMonth: string = "") => {
    try {
      ...
      console.log("error getBotInquiriesTrend: ", error);
    }
  };
  ...
  }, [botInquiriesTrend, trendYearsNames]);
...
export default BotInquiriesTrendChart;
