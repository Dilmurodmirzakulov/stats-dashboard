...
import { getWeeklyCustomersCenter } from "../../../api";
import { setWeeklyCustomersCenter } from "../../../store/slices/AskWIUT/WeeklyCustomersCenterSlice";
import { getWeeklyCustomersCenterLatest } from "../../../api/AskWIUT/WeeklyCustomersCenter/latest";

const WeeklyCustomersCenterChart = () => {
  ...
  const handleGetWeeklyCustomersCenter = async (filteredMonth: string = "") => {
    try {
      ...
      console.log("error getWeeklyCustomersCenter: ", error);
    }
  };
  ...
  useEffect(() => {
    if (!weeklyCustomersCenter) return;
    setData(
      weeklyCustomersCenter.map((x) => ({
        name: x.name,
        value: x.value,
      }))
    );
...
export default WeeklyCustomersCenterChart;
