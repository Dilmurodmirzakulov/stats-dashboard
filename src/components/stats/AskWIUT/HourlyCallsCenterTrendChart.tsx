...
import { getHourlyCallsCenterTrendLatest } from "../../../api/AskWIUT/HourlyCallsCenterTrend/latest";

const HourlyCallsCenterTrendChart: FC = () => {
  ...
  const handleGetHourlyCallsCenterTrend = async (
    ...
    try {
      ...
      console.log("error getHourlyCallsCenterTrend: ", error);
    }
  };
  ...
  }, [hourlyCallsCenterTrend, trendYearsNames]);
...
export default HourlyCallsCenterTrendChart;
