...
import { getWeeklyCallsCenterTrendLatest } from "../../../api/AskWIUT/WeeklyCallsCenterTrend/latest";

const WeeklyCallsCenterTrendChart: FC = () => {
  ...
  const handleGetWeeklyCallsCenterTrend = async (
    ...
    try {
      ...
      console.log("error getWeeklyCallsCenterTrend: ", error);
    }
  };
  ...
  }, [weeklyCallsCenterTrend, trendYearsNames]);
...
export default WeeklyCallsCenterTrendChart;
