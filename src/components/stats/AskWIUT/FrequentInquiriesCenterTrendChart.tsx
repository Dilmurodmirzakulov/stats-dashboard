...
import { getFrequentInquiriesCenterTrendLatest } from "../../../api/AskWIUT/FrequentInquiriesCenterTrend/latest";

const FrequentInquiriesCenterTrendChart: FC = () => {
  ...
  const handleGetFrequentInquiriesCenterTrend = async (
    ...
    try {
      ...
      console.log("error getFrequentInquiriesCenterTrend: ", error);
    }
  };
  ...
  useEffect(() => {
    if (!frequentInquiriesCenterTrend) {
    ...
    setData(
      frequentInquiriesCenterTrend.map((x) => ({
        name: x.name,
  ...
  }, [frequentInquiriesCenterTrend, trendYearsNames]);
...
export default FrequentInquiriesCenterTrendChart;
