...
import { getFrequentInquiriesByCategoryTrendLatest } from "../../../api/AskWIUT/FrequentInquiriesByCategoryTrend/latest";

const FrequentInquiriesByCategoryTrendChart: FC = () => {
  ...
  const handleGetFrequentInquiriesByCategoryTrend = async (
    ...
    try {
      ...
      console.log("error getFrequentInquiriesByCategoryTrend: ", error);
    }
  };
  ...
  useEffect(() => {
    if (!frequentInquiriesByCategoryTrend) {
    ...
    setData(
      frequentInquiriesByCategoryTrend.map((x) => ({
        name: x.name,
  ...
  }, [frequentInquiriesByCategoryTrend, trendYearsNames]);
...
export default FrequentInquiriesByCategoryTrendChart;
