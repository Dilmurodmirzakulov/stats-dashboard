...
import { getNumberOfInquiriesByTypeTrendLatest } from "../../../api/AskWIUT/NumberOfInquiriesByTypeTrend/latest";

const NumberOfInquiriesByTypeTrendChart: FC = () => {
  ...
  const handleGetNumberOfInquiriesByTypeTrend = async (
    ...
    try {
      ...
      console.log("error getNumberOfInquiriesByTypeTrend: ", error);
    }
  };
  ...
  useEffect(() => {
    if (!numberOfInquiriesByTypeTrend) {
    ...
    setData(
      numberOfInquiriesByTypeTrend.map((x) => ({
        name: x.name,
  ...
  }, [numberOfInquiriesByTypeTrend, trendYearsNames]);
...
export default NumberOfInquiriesByTypeTrendChart;
