...
import { getWeeklyCustomersCenterTrendLatest } from "../../../api/AskWIUT/WeeklyCustomersCenterTrend/latest";

const WeeklyCustomersCenterTrendChart: FC = () => {
  ...
  const handleGetWeeklyCustomersCenterTrend = async (
    ...
    try {
      ...
      console.log("error getWeeklyCustomersCenterTrend: ", error);
    }
  };
  ...
  useEffect(() => {
    ...
    setData(
      weeklyCustomersCenterTrend.map((x) => ({
        name: x.name,
  ...
  }, [weeklyCustomersCenterTrend, trendYearsNames]);
...
export default WeeklyCustomersCenterTrendChart;
