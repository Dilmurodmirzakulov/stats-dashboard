...
const StaffPositionTable = () => {
  ...
  const handleCreateStaffPosition = async () => {
    ...
    try {
      ...
      console.log("createStaffPosition error:", error);
    }
  };
  ...
  const handleGetStaffPosition = async (filteredMonth: string = "") => {
    try {
      ...
      console.log("getStaffPosition error:", error);
    }
  };
  ...
  const handleDeleteStaffPosition = async (id: number) => {
    try {
      await deleteStaffPosition(id);
      handleGetStaffPosition(filteredMonth);
    } catch (error) {
      console.log("deleteStaffPosition error:", error);
    }
  };
  ...
  const handleUpdateStats = async () => {
    ...
    try {
      ...
      console.log("updateStaffPosition error:", error);
    }
  };

  const handleUpdateClick = (x: StaffPositionData) => {
          ...
          staffPosition.map((x, idx) => (
            <tr key={"staffPosition-id-" + x.id}>
              ...
              <td className="text-end">
                ...
                <button
                  className="btn p-1"
                  onClick={() => handleDeleteStaffPosition(x.id)}
                >
        ...
        <tr>
          ...
          <td className="text-end">
            <button
              ...
              onClick={handleCreateStaffPosition}
            >
